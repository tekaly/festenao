                ...
                [
                  ...
                  SubMenuItem(
                      ...
                      items: imagesMenuItems(
                          dbArticle: dbEvent, articleId: dbArticle?.id))
                ].popupMenu(context),
            ...
            body: GestureDetector(
              onTap: () async {
                if (bloc.state.valueOrNull?.eventId != null) {
                  await goToAdminEventEditScreen(context,
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView(children: [
                    if (event == null)
                      ...
                      if (artistId != null)
                        getImagesPreview(
                            articleKind: articleKindArtist, articleId: artistId)
                    ]
                  ]);
                },
              ),
            ...
            floatingActionButton: ValueStreamBuilder<AdminEventScreenBlocState>(
                ...
                builder: (context, snapshot) {
                  ...
                  return FloatingActionButton(
                    onPressed: () async {
                      var result = await goToAdminEventEditScreen(context,
